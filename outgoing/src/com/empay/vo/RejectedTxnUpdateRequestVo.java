...
public class RejectedTxnUpdateRequestVo {
    @NotNull(message="mti must not be null;")
    @NotBlank(message="mti must not be empty/blank;")
    @Size(max=4, message="mti should not exceed 4 characters;")
    private @NotNull(message="mti must not be null;") @NotBlank(message="mti must not be empty/blank;") @Size(max=4, message="mti should not exceed 4 characters;") String mti;
    @NotNull(message="processingCode must not be null;")
    @NotBlank(message="processingCode must not be empty/blank;")
    @Size(max=6, message="processingCode should not exceed 6 characters;")
    private @NotNull(message="processingCode must not be null;") @NotBlank(message="processingCode must not be empty/blank;") @Size(max=6, message="processingCode should not exceed 6 characters;") String processingCode;
    @NotNull(message="rrn must not be null;")
    @NotBlank(message="rrn must not be empty/blank;")
    @Size(max=12, message="rrn should not exceed 12 characters;")
    private @NotNull(message="rrn must not be null;") @NotBlank(message="rrn must not be empty/blank;") @Size(max=12, message="rrn should not exceed 12 characters;") String rrn;
    private String transactionType;
    @NotNull(message="cardNumber must not be null;")
    @NotBlank(message="cardNumber must not be empty/blank;")
    private @NotNull(message="cardNumber must not be null;") @NotBlank(message="cardNumber must not be empty/blank;") String cardNumber;
    @NotNull(message="transactionAmount must not be null;")
    @NotBlank(message="transactionAmount must not be empty/blank;")
    private @NotNull(message="transactionAmount must not be null;") @NotBlank(message="transactionAmount must not be empty/blank;") String transactionAmount;
    @NotNull(message="surchargeAmount must not be null;")
    @NotBlank(message="surchargeAmount must not be empty/blank;")
    private @NotNull(message="surchargeAmount must not be null;") @NotBlank(message="surchargeAmount must not be empty/blank;") String surchargeAmount;
    @NotNull(message="localDateTime must not be null;")
    @NotBlank(message="localDateTime must not be empty/blank;")
    private @NotNull(message="localDateTime must not be null;") @NotBlank(message="localDateTime must not be empty/blank;") String localDateTime;
    @NotNull(message="expiryDate must not be null;")
    @NotBlank(message="expiryDate must not be empty/blank;")
    private @NotNull(message="expiryDate must not be null;") @NotBlank(message="expiryDate must not be empty/blank;") String expiryDate;
    @NotNull(message="posDataCode must not be null;")
    @NotBlank(message="posDataCode must not be empty/blank;")
    private @NotNull(message="posDataCode must not be null;") @NotBlank(message="posDataCode must not be empty/blank;") String posDataCode;
    @NotNull(message="functionCode must not be null;")
    @NotBlank(message="functionCode must not be empty/blank;")
    private @NotNull(message="functionCode must not be null;") @NotBlank(message="functionCode must not be empty/blank;") String functionCode;
    @NotNull(message="messageReasonCode must not be null;")
    @NotBlank(message="messageReasonCode must not be empty/blank;")
    private @NotNull(message="messageReasonCode must not be null;") @NotBlank(message="messageReasonCode must not be empty/blank;") String messageReasonCode;
    @NotNull(message="mcc must not be null;")
    @NotBlank(message="mcc must not be empty/blank;")
    private @NotNull(message="mcc must not be null;") @NotBlank(message="mcc must not be empty/blank;") String mcc;
    @NotNull(message="arn must not be null;")
    @NotBlank(message="arn must not be empty/blank;")
    private @NotNull(message="arn must not be null;") @NotBlank(message="arn must not be empty/blank;") String arn;
    @NotNull(message="acquireInstitutionId must not be null;")
    @NotBlank(message="acquireInstitutionId must not be empty/blank;")
    private @NotNull(message="acquireInstitutionId must not be null;") @NotBlank(message="acquireInstitutionId must not be empty/blank;") String acquireInstitutionId;
    @NotNull(message="approvalCode must not be null;")
    @NotBlank(message="approvalCode must not be empty/blank;")
    private @NotNull(message="approvalCode must not be null;") @NotBlank(message="approvalCode must not be empty/blank;") String approvalCode;
    private String responseCode;
    @NotNull(message="seviceCode must not be null;")
    @NotBlank(message="seviceCode must not be empty/blank;")
    private @NotNull(message="seviceCode must not be null;") @NotBlank(message="seviceCode must not be empty/blank;") String seviceCode;
    @NotNull(message="merchantName must not be null;")
    @NotBlank(message="merchantName must not be empty/blank;")
    private @NotNull(message="merchantName must not be null;") @NotBlank(message="merchantName must not be empty/blank;") String merchantName;
    @NotNull(message="merchantCity must not be null;")
    @NotBlank(message="merchantCity must not be empty/blank;")
    private @NotNull(message="merchantCity must not be null;") @NotBlank(message="merchantCity must not be empty/blank;") String merchantCity;
    @NotNull(message="merchantZipCode must not be null;")
    @NotBlank(message="merchantZipCode must not be empty/blank;")
    private @NotNull(message="merchantZipCode must not be null;") @NotBlank(message="merchantZipCode must not be empty/blank;") String merchantZipCode;
    @NotNull(message="merchantCountry must not be null;")
    @NotBlank(message="merchantCountry must not be empty/blank;")
    private @NotNull(message="merchantCountry must not be null;") @NotBlank(message="merchantCountry must not be empty/blank;") String merchantCountry;
    @NotNull(message="terminalType must not be null;")
    @NotBlank(message="terminalType must not be empty/blank;")
    private @NotNull(message="terminalType must not be null;") @NotBlank(message="terminalType must not be empty/blank;") String terminalType;
    private String ecomIndicator;
    private String transactionFeeAmount;
    @NotNull(message="transactionCurrencyExponent must not be null;")
    @NotBlank(message="transactionCurrencyExponent must not be empty/blank;")
    private @NotNull(message="transactionCurrencyExponent must not be null;") @NotBlank(message="transactionCurrencyExponent must not be empty/blank;") String transactionCurrencyExponent;
    @NotNull(message="transactionCurrencyCode must not be null;")
    @NotBlank(message="transactionCurrencyCode must not be empty/blank;")
    private @NotNull(message="transactionCurrencyCode must not be null;") @NotBlank(message="transactionCurrencyCode must not be empty/blank;") String transactionCurrencyCode;
    @NotNull(message="ird must not be null;")
    @NotBlank(message="ird must not be empty/blank;")
    private @NotNull(message="ird must not be null;") @NotBlank(message="ird must not be empty/blank;") String ird;
    @NotNull(message="settledIndicator must not be null;")
    @NotBlank(message="settledIndicator must not be empty/blank;")
    private @NotNull(message="settledIndicator must not be null;") @NotBlank(message="settledIndicator must not be empty/blank;") String settledIndicator;
    ...
    @NotNull(message="chipTransactionType must not be null;")
    @NotBlank(message="chipTransactionType must not be empty/blank;")
    private @NotNull(message="chipTransactionType must not be null;") @NotBlank(message="chipTransactionType must not be empty/blank;") String chipTransactionType;
    ...
    @NotNull(message="independentSalesOrganizationId must not be null;")
    @NotBlank(message="independentSalesOrganizationId must not be empty/blank;")
    private @NotNull(message="independentSalesOrganizationId must not be null;") @NotBlank(message="independentSalesOrganizationId must not be empty/blank;") String independentSalesOrganizationId;
    private String reversalIndicator;
    @NotNull(message="mastercardAssignedId must not be null;")
    @NotBlank(message="mastercardAssignedId must not be empty/blank;")
    private @NotNull(message="mastercardAssignedId must not be null;") @NotBlank(message="mastercardAssignedId must not be empty/blank;") String mastercardAssignedId;
    @NotNull(message="cardType must not be null;")
    @NotBlank(message="cardType must not be empty/blank;")
    private @NotNull(message="cardType must not be null;") @NotBlank(message="cardType must not be empty/blank;") String cardType;
    @NotNull(message="domesticInternationFlag must not be null;")
    @NotBlank(message="domesticInternationFlag must not be empty/blank;")
    private @NotNull(message="domesticInternationFlag must not be null;") @NotBlank(message="domesticInternationFlag must not be empty/blank;") String domesticInternationFlag;
    @NotNull(message="smsDmsFlag must not be null;")
    @NotBlank(message="smsDmsFlag must not be empty/blank;")
    private @NotNull(message="smsDmsFlag must not be null;") @NotBlank(message="smsDmsFlag must not be empty/blank;") String smsDmsFlag;
    @NotNull(message="posPgType must not be null;")
    @NotBlank(message="posPgType must not be empty/blank;")
    private @NotNull(message="posPgType must not be null;") @NotBlank(message="posPgType must not be empty/blank;") String posPgType;
    @NotNull(message="centralProcessingDate must not be null;")
    @NotBlank(message="centralProcessingDate must not be empty/blank;")
    private @NotNull(message="centralProcessingDate must not be null;") @NotBlank(message="centralProcessingDate must not be empty/blank;") String centralProcessingDate;
    @NotNull(message="outgoingFileDate must not be null;")
    @NotBlank(message="outgoingFileDate must not be empty/blank;")
    private @NotNull(message="outgoingFileDate must not be null;") @NotBlank(message="outgoingFileDate must not be empty/blank;") String outgoingFileDate;
    @NotNull(message="fileId must not be null;")
    @NotBlank(message="fileId must not be empty/blank;")
    private @NotNull(message="fileId must not be null;") @NotBlank(message="fileId must not be empty/blank;") String fileId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RejectedTxnUpdateRequestVo)) {
            return false;
        }
        RejectedTxnUpdateRequestVo other = (RejectedTxnUpdateRequestVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof RejectedTxnUpdateRequestVo;
    }
