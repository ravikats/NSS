...
@Entity
@Table(name="JAYWAN_ACQ_TXN_DATA")
public class JaywanAcqTxnDataEntity {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JaywanAcqTxnDataEntity)) {
            return false;
        }
        JaywanAcqTxnDataEntity other = (JaywanAcqTxnDataEntity)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof JaywanAcqTxnDataEntity;
    }
