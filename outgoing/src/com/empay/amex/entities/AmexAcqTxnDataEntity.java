...
@Entity
@Table(name="AMEX_ACQ_TXN_DATA")
public class AmexAcqTxnDataEntity {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AmexAcqTxnDataEntity)) {
            return false;
        }
        AmexAcqTxnDataEntity other = (AmexAcqTxnDataEntity)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AmexAcqTxnDataEntity;
    }
