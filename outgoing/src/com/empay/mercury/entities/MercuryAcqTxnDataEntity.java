 ...
 *  com.empay.mercury.entities.MercuryAcqTxnDataEntity$MercuryAcqTxnDataEntityBuilder
...
@Entity
@Table(name="MERCURY_ACQ_TXN_DATA")
public class MercuryAcqTxnDataEntity {
    @Id
    ...
    public static MercuryAcqTxnDataEntityBuilder builder() {
        return new MercuryAcqTxnDataEntityBuilder();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MercuryAcqTxnDataEntity)) {
            return false;
        }
        MercuryAcqTxnDataEntity other = (MercuryAcqTxnDataEntity)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MercuryAcqTxnDataEntity;
    }
