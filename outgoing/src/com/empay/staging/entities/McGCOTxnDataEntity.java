...
@Entity
@Table(name="MC_GCO_DATA")
public class McGCOTxnDataEntity {
    @Id
    @Column(name="MGD_SER_NUMBER")
    private Integer serialNumber;
    @Column(name="MGD_LAST_UPDATED")
    private LocalDateTime lastUpdated;
    @Column(name="MGD_UPDATED_USER")
    private Integer updatedUser;
    @Column(name="MGD_INS_CODE")
    private int insCode;
    @Column(name="MGD_INT_CODE")
    private int intCode;
    @Column(name="MGD_GEN_STATUS")
    private int generalStatus;
    @Column(name="MGD_NETWORK")
    private String network;
    @Column(name="MGD_TXN_REF_NUMBER")
    private Integer txnRefSerNumber;
    @Column(name="MGD_PRJ_SER_NUMBER")
    private Integer prjSerNumber;
    @Column(name="MGD_BUSS_DATE")
    private LocalDate businessDate;
    @Column(name="MGD_PROC_CODE")
    private String procCode;
    @Column(name="MGD_APPR_CODE")
    private String approvalCode;
    @Column(name="MGD_SERVICE_CODE")
    private String serviceCode;
    @Column(name="MGD_OUT_FILE_DATE")
    private LocalDate fileProcDate;
    @Column(name="MGD_MTI")
    private String mti;
    @Column(name="MGD_TXN_TYPE")
    private String txnType;
    @Column(name="MGD_TXN_AMOUNT", nullable=false)
    private Double txnAmount;
    @Column(name="MGD_SCHG_AMOUNT", nullable=false)
    private Double surchargeAmount;
    @Column(name="MGD_LOCAL_DATE_TIME")
    private LocalDateTime localDateTime;
    @Column(name="MGD_CH_PRESENT")
    private String chPresent;
    @Column(name="MGD_CARD_PRESENT")
    private String cardPresent;
    @Column(name="MGD_POS_ENTRY_MODE")
    private String posEntryMode;
    @Column(name="MGD_POS_DATA_MODE")
    private String posDataMode;
    @Column(name="MGD_MCC")
    private String mcc;
    @Column(name="MGD_ACQ_INST_ID_CODE")
    private String acqInstIdCode;
    @Column(name="MGD_RET_REF_NUMBER")
    private String rrn;
    @Column(name="MGD_ACQ_REF_DATA")
    private String arn;
    @Column(name="MGD_TERMINAL_ID")
    private String terminalId;
    @Column(name="MGD_MERCHANT_ID")
    private String merchantId;
    @Column(name="MGD_ME_NAME")
    private String meName;
    @Column(name="MGD_ME_ADDRESS")
    private String meAddress;
    @Column(name="MGD_ME_CITY")
    private String meCity;
    @Column(name="MGD_ME_ZIP_CODE")
    private String meZipCode;
    @Column(name="MGD_TXN_CUR_CODE")
    private String txnCurCode;
    @Column(name="MGD_ME_COUNTRY")
    private String meCountry;
    @Column(name="MGD_FILE_ID")
    private String fileId;
    @Column(name="MGD_ENC_CARD_NUMBER")
    private String encryptedCardNumber;
    @Column(name="MGD_SETL_INDICATOR")
    private Character settlementIndicator;
    @Column(name="MGD_TXN_LIFE_CYCL_ID")
    private String txnlifeCycleId;
    @Column(name="MGD_FUNC_CODE")
    private String functionCode;
    @Column(name="MGD_MSG_REASON_CODE")
    private String msgReasonCode;
    @Column(name="MGD_CARD_TYPE")
    private Character cardType;
    @Column(name="MGD_CARD_DOM_INTL_FLAG")
    private Character cardDomIntlFlag;
    @Column(name="MGD_MPOS_ACC_DEV_TYPE")
    private Character mposAccDevType;
    @Column(name="MGD_ACC_URL_ADDRESS")
    private String accepterUrlAddress;
    @Column(name="MGD_TXN_CURR_EXP")
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof McGCOTxnDataEntity)) {
            return false;
        }
        McGCOTxnDataEntity other = (McGCOTxnDataEntity)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof McGCOTxnDataEntity;
    }
