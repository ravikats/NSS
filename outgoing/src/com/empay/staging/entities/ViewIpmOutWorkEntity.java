...
@Entity
@Table(name="VW_IPM_OUT_WORK")
public class ViewIpmOutWorkEntity {
    @Id
    ...
    @Column(name="DE048_PDS0213")
    private String de048Pds0213;
    ...
    @Column(name="DE048_0170")
    private String de0480170;
    @Column(name="DE048_0018")
    private String de0480018;
    @Column(name="DE048_0175")
    private String de0480175;
    ...
    public String getDe048Pds0213() {
        return this.de048Pds0213;
    }
    ...
    public String getDe0480170() {
        return this.de0480170;
    }

    public String getDe0480018() {
        return this.de0480018;
    }

    public String getDe0480175() {
        return this.de0480175;
    }
    ...
    public void setDe048Pds0213(String de048Pds0213) {
        this.de048Pds0213 = de048Pds0213;
    }
    ...
    public void setDe0480170(String de0480170) {
        this.de0480170 = de0480170;
    }

    public void setDe0480018(String de0480018) {
        this.de0480018 = de0480018;
    }

    public void setDe0480175(String de0480175) {
        this.de0480175 = de0480175;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ViewIpmOutWorkEntity)) {
            return false;
        }
        ViewIpmOutWorkEntity other = (ViewIpmOutWorkEntity)o;
        ...
        if (this$txnAmount == null ? other$txnAmount != null : !this$txnAmount.equals(other$txnAmount)) {
            return false;
        }
        String this$de048Pds0213 = this.getDe048Pds0213();
        String other$de048Pds0213 = other.getDe048Pds0213();
        if (this$de048Pds0213 == null ? other$de048Pds0213 != null : !this$de048Pds0213.equals(other$de048Pds0213)) {
            return false;
        }
        ...
        String this$de0480170 = this.getDe0480170();
        String other$de0480170 = other.getDe0480170();
        if (this$de0480170 == null ? other$de0480170 != null : !this$de0480170.equals(other$de0480170)) {
            return false;
        }
        String this$de0480018 = this.getDe0480018();
        String other$de0480018 = other.getDe0480018();
        if (this$de0480018 == null ? other$de0480018 != null : !this$de0480018.equals(other$de0480018)) {
            return false;
        }
        String this$de0480175 = this.getDe0480175();
        String other$de0480175 = other.getDe0480175();
        return !(this$de0480175 == null ? other$de0480175 != null : !this$de0480175.equals(other$de0480175));
    }

    protected boolean canEqual(Object other) {
        return other instanceof ViewIpmOutWorkEntity;
    }
    ...
    public int hashCode() {
        ...
        String $de048Pds0213 = this.getDe048Pds0213();
        result = result * 59 + ($de048Pds0213 == null ? 43 : $de048Pds0213.hashCode());
