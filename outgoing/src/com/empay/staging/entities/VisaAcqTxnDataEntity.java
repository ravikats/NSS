...
@Entity
@Table(name="VISA_ACQ_TXN_DATA")
public class VisaAcqTxnDataEntity {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VisaAcqTxnDataEntity)) {
            return false;
        }
        VisaAcqTxnDataEntity other = (VisaAcqTxnDataEntity)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VisaAcqTxnDataEntity;
    }
