 ...
 *  com.empay.staging.entities.VisaGOCDataEntity$VisaGOCDataEntityBuilder
...
@Entity
@Table(name="VISA_GOC_DATA")
public class VisaGOCDataEntity {
    @Id
    ...
    @Column(name="GOC_FILE_ID")
    private String fileId;
    @Column(name="GOC_SENDER_NAME")
    private String senderName;
    @Column(name="GOC_RECIPIENT_NAME")
    private String recipientName;
    @Column(name="GOC_BUSS_APP_ID")
    private String bussAppId;
    @Column(name="GOC_SENDER_ACCOUNT")
    ...
    public static VisaGOCDataEntityBuilder builder() {
        return new VisaGOCDataEntityBuilder();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VisaGOCDataEntity)) {
            return false;
        }
        VisaGOCDataEntity other = (VisaGOCDataEntity)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof VisaGOCDataEntity;
    }
