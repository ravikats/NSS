...
public class McAcqTxnWorkEntity {
    ...
    public McAcqTxnWorkEntity(Integer serNumber, LocalDateTime lastUpdated, Integer updatedUser, int institutionCode, Integer intCode, Integer prjSerNumber, int generalStatus, Integer txnRefSerNumber, String txnType, String fileID, String messageTypeId, String procCode, String functionCode, Double txnAmount, Double surchargeAmount, LocalDate fileProcDate, String cardNumber, LocalDateTime localDateTime, String expiryDate, String posDataCode, String msgReasonCode, String mcc, String acqRefData, String acqinstIdCode, String rrn, String approvalCode, String responseCode, String serviceCode, String terminalId, String merchantId, String meName, String meCity, String mePinCode, String meCountry, String trlType, String motoEcomIndicator, Double txnFeeAmount, int txnCurrExp, String txnCurCode, String ird, Character settlementIndicator, String cardSeqNumber, String appCryptogram, String cryptInfoData, String issAppData, String upblNumber, String appTxnCounter, String trlVerResult, LocalDate txnDate, String chipTxnDate, String chipTxnType, Double cryptAmount, String appICProfile, String trlConCode, Double chipCashBack, String cvmResult, String trlCapabilities, String ifdSerNumber, String tcc, String chipCurCode, String chipTrlType, String trlAppVerNumber, String txnSeqCounter, String issAuthData, String txnlifeCycleId, String msgNumber, String memberText, String orgInstIdCode, Character revIndiCator, String maid, Character cardType, Character cardDomIntlFlag, Character dmsSmsMode, String posPgType, LocalDate centreProcDate, String encryptedCardNumber, Integer mrpSerNumber, String meCountryOfOrigin, Double tipAmount, String chipTrlCapabilities, String dedicatedFileName, String cardAccepStreetAddress, String customerServicePhNum, Character dccIndicator, String dccCurrency, Double dccAmount, Integer dccTxnCurrencyExponent, Character mposAccDevType, String accepterUrlAddress) {
        this.serNumber = serNumber;
        this.lastUpdated = lastUpdated;
        this.updatedUser = updatedUser;
        this.institutionCode = institutionCode;
