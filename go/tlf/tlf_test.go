...
func TestTlf_CalculateVisaFallback(t *testing.T) {
	...
	// callback enqueue (irf-service owns IRF_CALLBACK now)
...
func TestTlf_FlushAndRetry(t *testing.T) {
	c, _ := stub.NewClient(t)
	client := IrfClient{Client: c}
...
func TestTlf_BadSecret_Unauthorized(t *testing.T) {
