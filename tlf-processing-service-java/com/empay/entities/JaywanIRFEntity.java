...
public class JaywanIRFEntity
{
    ...
    public boolean equals(final Object o) {
        ...
        final JaywanIRFEntity other = (JaywanIRFEntity)o;
    ...
    public static class JaywanIRFEntityBuilder
    {
        private Integer serialNumber;
        private LocalDateTime lastUpdated;
        private String segment;
        ...
        JaywanIRFEntityBuilder() {
        }
        
        public JaywanIRFEntityBuilder serialNumber(final Integer serialNumber) {
            this.serialNumber = serialNumber;
            return this;
        }
        
        public JaywanIRFEntityBuilder lastUpdated(final LocalDateTime lastUpdated) {
            this.lastUpdated = lastUpdated;
            return this;
        }
        
        public JaywanIRFEntityBuilder segment(final String segment) {
            this.segment = segment;
            return this;
        }
        
        public JaywanIRFEntityBuilder segmentDesc(final String segmentDesc) {
            this.segmentDesc = segmentDesc;
            return this;
        }
        
        public JaywanIRFEntityBuilder mcc(final String mcc) {
            this.mcc = mcc;
            return this;
        }
        
        public JaywanIRFEntityBuilder mccDesc(final String mccDesc) {
            this.mccDesc = mccDesc;
            return this;
        }
        
        public JaywanIRFEntityBuilder irfRate(final Double irfRate) {
            this.irfRate = irfRate;
            return this;
        }
        
        public JaywanIRFEntityBuilder irfMax(final Double irfMax) {
            this.irfMax = irfMax;
            return this;
        }
        
        public JaywanIRFEntityBuilder irfFixed(final Double irfFixed) {
            this.irfFixed = irfFixed;
            return this;
        }
        
        public JaywanIRFEntityBuilder posIrf(final Double posIrf) {
            this.posIrf = posIrf;
            return this;
        }
        
        public JaywanIRFEntityBuilder ecomIrf(final Double ecomIrf) {
            this.ecomIrf = ecomIrf;
            return this;
        }
        
        public JaywanIRFEntityBuilder posIrfMax(final Double posIrfMax) {
            this.posIrfMax = posIrfMax;
            return this;
        }
        
        public JaywanIRFEntityBuilder ecomIrfMax(final Double ecomIrfMax) {
            this.ecomIrfMax = ecomIrfMax;
            return this;
        }
        
        public JaywanIRFEntity build() {
            return new JaywanIRFEntity(this.serialNumber, this.lastUpdated, this.segment, this.segmentDesc, this.mcc, this.mccDesc, this.irfRate, this.irfMax, this.irfFixed, this.posIrf, this.ecomIrf, this.posIrfMax, this.ecomIrfMax);
        }
        
        @Override
        public String toString() {
            return "JaywanIRFEntity.JaywanIRFEntityBuilder(serialNumber=" + this.serialNumber + ", lastUpdated=" + String.valueOf(this.lastUpdated) + ", segment=" + this.segment + ", segmentDesc=" + this.segmentDesc + ", mcc=" + this.mcc + ", mccDesc=" + this.mccDesc + ", irfRate=" + this.irfRate + ", irfMax=" + this.irfMax + ", irfFixed=" + this.irfFixed + ", posIrf=" + this.posIrf + ", ecomIrf=" + this.ecomIrf + ", posIrfMax=" + this.posIrfMax + ", ecomIrfMax=" + this.ecomIrfMax;
        }
    }
}
