...
@Entity
@Table(name = "VISA_GOC_WORK")
public class VisaGOCWorkEntity
{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "GOC_SER_NUMBER")
    private Integer serNumber;
    @Column(name = "GOC_LAST_UPDATED")
    private LocalDateTime lastUpdated;
    @Column(name = "GOC_UPDATED_USER")
    private Integer updatedUser;
    @Column(name = "GOC_INS_CODE")
    private int institutionCode;
    @Column(name = "GOC_INT_CODE")
    private Integer intCode;
    @Column(name = "GOC_PRJ_SER_NUMBER")
    private Integer prjSerNumber;
    @Column(name = "GOC_GEN_STATUS")
    private Integer genStatus;
    @Column(name = "GOC_NETWORK")
    private String network;
    @Column(name = "GOC_TXN_REF_NUMBER")
    private Integer txnRefNumber;
    @Column(name = "GOC_TXN_TYPE")
    private String txnType;
    @Column(name = "GOC_TXN_CODE")
    private String txnCode;
    @Column(name = "GOC_ENC_CARD_NUMBER")
    private String encCardNumber;
    @Column(name = "GOC_ACQ_REF_NUMBER")
    private String arn;
    @Column(name = "GOC_PURCHASE_DATE")
    private LocalDateTime purchaseDate;
    @Column(name = "GOC_TXN_CUR_CODE")
    private String txnCurCode;
    @Column(name = "GOC_TXN_AMOUNT")
    private Double txnAmount;
    @Column(name = "GOC_SCHG_AMOUNT")
    private Double schgAmount;
    @Column(name = "GOC_ME_NAME")
    private String meName;
    @Column(name = "GOC_ME_CITY")
    private String meCity;
    @Column(name = "GOC_ME_COUNTRY")
    private String meCountry;
    @Column(name = "GOC_MCC")
    private String mcc;
    @Column(name = "GOC_APPR_CODE")
    private String approvalCode;
    @Column(name = "GOC_CH_ID_METHOD")
    private Character chIdMethod;
    @Column(name = "GOC_POS_ENTRY_MODE")
    private String posEntryMode;
    @Column(name = "GOC_MEMBER_TEXT")
    private String memberText;
    @Column(name = "GOC_FEE_PRG_INDICATOR")
    private String feePrgIndicator;
    @Column(name = "GOC_MERCHANT_ID")
    private String merchantId;
    @Column(name = "GOC_TERMINAL_ID")
    private String terminalId;
    @Column(name = "GOC_MOTO_ECOM_INDICATOR")
    private Character motoEcomIndicator;
    @Column(name = "GOC_ACC_SELECTION")
    private Character accSelection;
    @Column(name = "GOC_ACQ_BUSS_ID")
    private String acqBussId;
    @Column(name = "GOC_POS_ENVIRONMENT")
    private Character posEnvironment;
    @Column(name = "GOC_RESP_CODE")
    private String respCode;
    @Column(name = "GOC_TRL_TXN_DATE")
    private LocalDate trlTxnDate;
    @Column(name = "GOC_CRYPT_AMOUNT")
    private Double cryptAmount;
    @Column(name = "GOC_CASHBACK_AMOUNT")
    private Double cashbackAmount;
    @Column(name = "GOC_TXN_ID")
    private String txnId;
    @Column(name = "GOC_VISA_TOKEN")
    private Character visaToken;
    @Column(name = "GOC_AUTH_CHAR_INDICATOR")
    private Character authCharIndicator;
    @Column(name = "GOC_ACC_FUND_SOURCE")
    private Character accFundSource;
    @Column(name = "GOC_MARKET_SPEC_DATA_IND")
    private Character marketSpecDataInd;
    @Column(name = "GOC_PRODUCT_ID")
    private String productId;
    @Column(name = "GOC_VALIDATION_CODE")
    private String validationCode;
    @Column(name = "GOC_SPEND_QUALI_IND")
    private Character spendQualiIndictor;
    @Column(name = "GOC_COLL_ONLY_FLAG")
    private Character collOnlyFlag;
    @Column(name = "GOC_RET_REF_NUMBER")
    private String retRefNumber;
    @Column(name = "GOC_PROC_CODE")
    private String procCode;
    @Column(name = "GOC_USAGE_CODE")
    private Character usageCode;
    @Column(name = "GOC_REASON_CODE")
    private String reasonCode;
    @Column(name = "GOC_SETL_FLAG")
    private Character setlFlag;
    @Column(name = "GOC_TRL_CAPABILITY")
    private Character terminalCapability;
    @Column(name = "GOC_REIMB_ATTRIBUTE")
    private Character reimAttribute;
    @Column(name = "GOC_STAN")
    private String stan;
    @Column(name = "GOC_AUTH_AMOUNT")
    private Double authAmount;
    @Column(name = "GOC_TRL_CAP_PROFILE")
    private String trlCapProfile;
    @Column(name = "GOC_TRL_CON_CODE")
    private String trlCountryCode;
    @Column(name = "GOC_UPBL_NUMBER")
    private String upblNumber;
    @Column(name = "GOC_CARD_SEQ_NUMBER")
    private String cardSeqNumber;
    @Column(name = "GOC_APP_TXN_COUNTER")
    private String appTxnCounter;
    @Column(name = "GOC_APP_IC_PROFILE")
    private String appIcProfile;
    @Column(name = "GOC_APP_CRYPTOGRAM")
    private String appCryptogram;
    @Column(name = "GOC_ISS_APP_DATA_B2")
    private String issAppDataB2;
    @Column(name = "GOC_ISS_APP_DATA_B3")
    private String issAppDataB3;
    @Column(name = "GOC_ISS_APP_DATA_B4")
    private String issAppDataB4;
    @Column(name = "GOC_ISS_APP_DATA_B8")
    private String issAppDataB8;
    @Column(name = "GOC_ISS_APP_DATA_B9")
    private String issAppDataB9;
    @Column(name = "GOC_ISS_APP_DATA_B1")
    private String issAppDataB1;
    @Column(name = "GOC_ISS_APP_DATA_B17")
    private String issAppDataB17;
    @Column(name = "GOC_ISS_APP_DATA_B18")
    private String issAppDataB18;
    @Column(name = "GOC_TRL_VER_RESULTS")
    private String trlVerResult;
    @Column(name = "GOC_FORM_FACT_INDICATOR")
    private String formFactorIndicator;
    @Column(name = "GOC_ISS_SCRIPT_RESULTS")
    private String issScriptResult;
    @Column(name = "GOC_SERVICE_CODE")
    private String serviceCode;
    @Column(name = "GOC_TXN_FEE_AMOUNT")
    private Double txnFeeAmount;
    @Column(name = "GOC_DCC_INDICATOR")
    private Character dccIndicator;
    @Column(name = "GOC_SMS_DMS_FLAG")
    private Character smsDmsFlag;
    @Column(name = "GOC_DOM_INTL_FLAG")
    private Character domIntlFlag;
    @Column(name = "GOC_CARD_TYPE")
    private Character cardType;
    @Column(name = "GOC_DCC_CURRENCY")
    private String dccCurrency;
    @Column(name = "GOC_DCC_AMOUNT")
    private Double dccAmount;
    @Column(name = "GOC_ACC_TRL_INDICATOR")
    private Character acceptanceTrlIndicator;
    
    public static VisaGOCWorkEntityBuilder builder() {
        return new VisaGOCWorkEntityBuilder();
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof VisaGOCWorkEntity)) {
            return false;
        }
        final VisaGOCWorkEntity other = (VisaGOCWorkEntity)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof VisaGOCWorkEntity;
    }
    ...
    public static class VisaGOCWorkEntityBuilder
    {
        private Integer serNumber;
        private LocalDateTime lastUpdated;
        private Integer updatedUser;
        ...
        VisaGOCWorkEntityBuilder() {
        }
        
        public VisaGOCWorkEntityBuilder serNumber(final Integer serNumber) {
            this.serNumber = serNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder lastUpdated(final LocalDateTime lastUpdated) {
            this.lastUpdated = lastUpdated;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder updatedUser(final Integer updatedUser) {
            this.updatedUser = updatedUser;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder institutionCode(final int institutionCode) {
            this.institutionCode = institutionCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder intCode(final Integer intCode) {
            this.intCode = intCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder prjSerNumber(final Integer prjSerNumber) {
            this.prjSerNumber = prjSerNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder genStatus(final Integer genStatus) {
            this.genStatus = genStatus;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder network(final String network) {
            this.network = network;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnRefNumber(final Integer txnRefNumber) {
            this.txnRefNumber = txnRefNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnType(final String txnType) {
            this.txnType = txnType;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnCode(final String txnCode) {
            this.txnCode = txnCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder encCardNumber(final String encCardNumber) {
            this.encCardNumber = encCardNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder arn(final String arn) {
            this.arn = arn;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder purchaseDate(final LocalDateTime purchaseDate) {
            this.purchaseDate = purchaseDate;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnCurCode(final String txnCurCode) {
            this.txnCurCode = txnCurCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnAmount(final Double txnAmount) {
            this.txnAmount = txnAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder schgAmount(final Double schgAmount) {
            this.schgAmount = schgAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder meName(final String meName) {
            this.meName = meName;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder meCity(final String meCity) {
            this.meCity = meCity;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder meCountry(final String meCountry) {
            this.meCountry = meCountry;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder mcc(final String mcc) {
            this.mcc = mcc;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder approvalCode(final String approvalCode) {
            this.approvalCode = approvalCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder chIdMethod(final Character chIdMethod) {
            this.chIdMethod = chIdMethod;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder posEntryMode(final String posEntryMode) {
            this.posEntryMode = posEntryMode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder memberText(final String memberText) {
            this.memberText = memberText;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder feePrgIndicator(final String feePrgIndicator) {
            this.feePrgIndicator = feePrgIndicator;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder merchantId(final String merchantId) {
            this.merchantId = merchantId;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder terminalId(final String terminalId) {
            this.terminalId = terminalId;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder motoEcomIndicator(final Character motoEcomIndicator) {
            this.motoEcomIndicator = motoEcomIndicator;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder accSelection(final Character accSelection) {
            this.accSelection = accSelection;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder acqBussId(final String acqBussId) {
            this.acqBussId = acqBussId;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder posEnvironment(final Character posEnvironment) {
            this.posEnvironment = posEnvironment;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder respCode(final String respCode) {
            this.respCode = respCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder trlTxnDate(final LocalDate trlTxnDate) {
            this.trlTxnDate = trlTxnDate;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder cryptAmount(final Double cryptAmount) {
            this.cryptAmount = cryptAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder cashbackAmount(final Double cashbackAmount) {
            this.cashbackAmount = cashbackAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnId(final String txnId) {
            this.txnId = txnId;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder visaToken(final Character visaToken) {
            this.visaToken = visaToken;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder authCharIndicator(final Character authCharIndicator) {
            this.authCharIndicator = authCharIndicator;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder accFundSource(final Character accFundSource) {
            this.accFundSource = accFundSource;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder marketSpecDataInd(final Character marketSpecDataInd) {
            this.marketSpecDataInd = marketSpecDataInd;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder productId(final String productId) {
            this.productId = productId;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder validationCode(final String validationCode) {
            this.validationCode = validationCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder spendQualiIndictor(final Character spendQualiIndictor) {
            this.spendQualiIndictor = spendQualiIndictor;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder collOnlyFlag(final Character collOnlyFlag) {
            this.collOnlyFlag = collOnlyFlag;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder retRefNumber(final String retRefNumber) {
            this.retRefNumber = retRefNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder procCode(final String procCode) {
            this.procCode = procCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder usageCode(final Character usageCode) {
            this.usageCode = usageCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder reasonCode(final String reasonCode) {
            this.reasonCode = reasonCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder setlFlag(final Character setlFlag) {
            this.setlFlag = setlFlag;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder terminalCapability(final Character terminalCapability) {
            this.terminalCapability = terminalCapability;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder reimAttribute(final Character reimAttribute) {
            this.reimAttribute = reimAttribute;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder stan(final String stan) {
            this.stan = stan;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder authAmount(final Double authAmount) {
            this.authAmount = authAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder trlCapProfile(final String trlCapProfile) {
            this.trlCapProfile = trlCapProfile;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder trlCountryCode(final String trlCountryCode) {
            this.trlCountryCode = trlCountryCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder upblNumber(final String upblNumber) {
            this.upblNumber = upblNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder cardSeqNumber(final String cardSeqNumber) {
            this.cardSeqNumber = cardSeqNumber;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder appTxnCounter(final String appTxnCounter) {
            this.appTxnCounter = appTxnCounter;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder appIcProfile(final String appIcProfile) {
            this.appIcProfile = appIcProfile;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder appCryptogram(final String appCryptogram) {
            this.appCryptogram = appCryptogram;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB2(final String issAppDataB2) {
            this.issAppDataB2 = issAppDataB2;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB3(final String issAppDataB3) {
            this.issAppDataB3 = issAppDataB3;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB4(final String issAppDataB4) {
            this.issAppDataB4 = issAppDataB4;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB8(final String issAppDataB8) {
            this.issAppDataB8 = issAppDataB8;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB9(final String issAppDataB9) {
            this.issAppDataB9 = issAppDataB9;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB1(final String issAppDataB1) {
            this.issAppDataB1 = issAppDataB1;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB17(final String issAppDataB17) {
            this.issAppDataB17 = issAppDataB17;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issAppDataB18(final String issAppDataB18) {
            this.issAppDataB18 = issAppDataB18;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder trlVerResult(final String trlVerResult) {
            this.trlVerResult = trlVerResult;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder formFactorIndicator(final String formFactorIndicator) {
            this.formFactorIndicator = formFactorIndicator;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder issScriptResult(final String issScriptResult) {
            this.issScriptResult = issScriptResult;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder serviceCode(final String serviceCode) {
            this.serviceCode = serviceCode;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder txnFeeAmount(final Double txnFeeAmount) {
            this.txnFeeAmount = txnFeeAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder dccIndicator(final Character dccIndicator) {
            this.dccIndicator = dccIndicator;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder smsDmsFlag(final Character smsDmsFlag) {
            this.smsDmsFlag = smsDmsFlag;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder domIntlFlag(final Character domIntlFlag) {
            this.domIntlFlag = domIntlFlag;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder cardType(final Character cardType) {
            this.cardType = cardType;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder dccCurrency(final String dccCurrency) {
            this.dccCurrency = dccCurrency;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder dccAmount(final Double dccAmount) {
            this.dccAmount = dccAmount;
            return this;
        }
        
        public VisaGOCWorkEntityBuilder acceptanceTrlIndicator(final Character acceptanceTrlIndicator) {
            this.acceptanceTrlIndicator = acceptanceTrlIndicator;
            return this;
        }
        
        public VisaGOCWorkEntity build() {
            return new VisaGOCWorkEntity(this.serNumber, this.lastUpdated, this.updatedUser, this.institutionCode, this.intCode, this.prjSerNumber, this.genStatus, this.network, this.txnRefNumber, this.txnType, this.txnCode, this.encCardNumber, this.arn, this.purchaseDate, this.txnCurCode, this.txnAmount, this.schgAmount, this.meName, this.meCity, this.meCountry, this.mcc, this.approvalCode, this.chIdMethod, this.posEntryMode, this.memberText, this.feePrgIndicator, this.merchantId, this.terminalId, this.motoEcomIndicator, this.accSelection, this.acqBussId, this.posEnvironment, this.respCode, this.trlTxnDate, this.cryptAmount, this.cashbackAmount, this.txnId, this.visaToken, this.authCharIndicator, this.accFundSource, this.marketSpecDataInd, this.productId, this.validationCode, this.spendQualiIndictor, this.collOnlyFlag, this.retRefNumber, this.procCode, this.usageCode, this.reasonCode, this.setlFlag, this.terminalCapability, this.reimAttribute, this.stan, this.authAmount, this.trlCapProfile, this.trlCountryCode, this.upblNumber, this.cardSeqNumber, this.appTxnCounter, this.appIcProfile, this.appCryptogram, this.issAppDataB2, this.issAppDataB3, this.issAppDataB4, this.issAppDataB8, this.issAppDataB9, this.issAppDataB1, this.issAppDataB17, this.issAppDataB18, this.trlVerResult, this.formFactorIndicator, this.issScriptResult, this.serviceCode, this.txnFeeAmount, this.dccIndicator, this.smsDmsFlag, this.domIntlFlag, this.cardType, this.dccCurrency, this.dccAmount, this.acceptanceTrlIndicator);
        }
        
        @Override
        public String toString() {
            return "VisaGOCWorkEntity.VisaGOCWorkEntityBuilder(serNumber=" + this.serNumber + ", lastUpdated=" + String.valueOf(this.lastUpdated) + ", updatedUser=" + this.updatedUser + ", institutionCode=" + this.institutionCode + ", intCode=" + this.intCode + ", prjSerNumber=" + this.prjSerNumber + ", genStatus=" + this.genStatus + ", network=" + this.network + ", txnRefNumber=" + this.txnRefNumber + ", txnType=" + this.txnType + ", txnCode=" + this.txnCode + ", encCardNumber=" + this.encCardNumber + ", arn=" + this.arn + ", purchaseDate=" + String.valueOf(this.purchaseDate) + ", txnCurCode=" + this.txnCurCode + ", txnAmount=" + this.txnAmount + ", schgAmount=" + this.schgAmount + ", meName=" + this.meName + ", meCity=" + this.meCity + ", meCountry=" + this.meCountry + ", mcc=" + this.mcc + ", approvalCode=" + this.approvalCode + ", chIdMethod=" + this.chIdMethod + ", posEntryMode=" + this.posEntryMode + ", memberText=" + this.memberText + ", feePrgIndicator=" + this.feePrgIndicator + ", merchantId=" + this.merchantId + ", terminalId=" + this.terminalId + ", motoEcomIndicator=" + this.motoEcomIndicator + ", accSelection=" + this.accSelection + ", acqBussId=" + this.acqBussId + ", posEnvironment=" + this.posEnvironment + ", respCode=" + this.respCode + ", trlTxnDate=" + String.valueOf(this.trlTxnDate) + ", cryptAmount=" + this.cryptAmount + ", cashbackAmount=" + this.cashbackAmount + ", txnId=" + this.txnId + ", visaToken=" + this.visaToken + ", authCharIndicator=" + this.authCharIndicator + ", accFundSource=" + this.accFundSource + ", marketSpecDataInd=" + this.marketSpecDataInd + ", productId=" + this.productId + ", validationCode=" + this.validationCode + ", spendQualiIndictor=" + this.spendQualiIndictor + ", collOnlyFlag=" + this.collOnlyFlag + ", retRefNumber=" + this.retRefNumber + ", procCode=" + this.procCode + ", usageCode=" + this.usageCode + ", reasonCode=" + this.reasonCode + ", setlFlag=" + this.setlFlag + ", terminalCapability=" + this.terminalCapability + ", reimAttribute=" + this.reimAttribute + ", stan=" + this.stan + ", authAmount=" + this.authAmount + ", trlCapProfile=" + this.trlCapProfile + ", trlCountryCode=" + this.trlCountryCode + ", upblNumber=" + this.upblNumber + ", cardSeqNumber=" + this.cardSeqNumber + ", appTxnCounter=" + this.appTxnCounter + ", appIcProfile=" + this.appIcProfile + ", appCryptogram=" + this.appCryptogram + ", issAppDataB2=" + this.issAppDataB2 + ", issAppDataB3=" + this.issAppDataB3 + ", issAppDataB4=" + this.issAppDataB4 + ", issAppDataB8=" + this.issAppDataB8 + ", issAppDataB9=" + this.issAppDataB9 + ", issAppDataB1=" + this.issAppDataB1 + ", issAppDataB17=" + this.issAppDataB17 + ", issAppDataB18=" + this.issAppDataB18 + ", trlVerResult=" + this.trlVerResult + ", formFactorIndicator=" + this.formFactorIndicator + ", issScriptResult=" + this.issScriptResult + ", serviceCode=" + this.serviceCode + ", txnFeeAmount=" + this.txnFeeAmount + ", dccIndicator=" + this.dccIndicator + ", smsDmsFlag=" + this.smsDmsFlag + ", domIntlFlag=" + this.domIntlFlag + ", cardType=" + this.cardType + ", dccCurrency=" + this.dccCurrency + ", dccAmount=" + this.dccAmount + ", acceptanceTrlIndicator=" + this.acceptanceTrlIndicator;
        }
    }
}
