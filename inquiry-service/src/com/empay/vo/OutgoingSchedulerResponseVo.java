...
public class OutgoingSchedulerResponseVo {
    public String name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OutgoingSchedulerResponseVo)) {
            return false;
        }
        OutgoingSchedulerResponseVo other = (OutgoingSchedulerResponseVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof OutgoingSchedulerResponseVo;
    }
    ...
    public String toString() {
        return "OutgoingSchedulerResponseVo(name=" + this.getName() + ", network=" + this.getNetwork() + ", isActive=" + this.getIsActive() + ", endTime=" + this.getEndTime() + ", editMode=" + this.getEditMode() + ", createdDateTime=" + this.getCreatedDateTime() + ", totalCount=" + this.getTotalCount() + ", totalPage=" + this.getTotalPage() + ")";
    }
}
