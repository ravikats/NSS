...
public class InquiryAPIRequestVo {
    ...
    private @NotBlank(message="Network is mandatory") @Pattern(regexp="^(?i)(MASTERCARD|VISA)$", message="INVALID_NETWORK;NETWORK is not recognized") String network;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InquiryAPIRequestVo)) {
            return false;
        }
        InquiryAPIRequestVo other = (InquiryAPIRequestVo)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof InquiryAPIRequestVo;
    }
    ...
    public String toString() {
        return "InquiryAPIRequestVo(fromDate=" + this.getFromDate() + ", toDate=" + this.getToDate() + ", network=" + this.getNetwork() + ")";
    }
}
