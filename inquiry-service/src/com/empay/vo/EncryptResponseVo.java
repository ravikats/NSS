 ...
 *  com.empay.vo.EncryptResponseVo
 */
...
public class EncryptResponseVo {
    ...
    public void setUuid(Map<String, String> uuid) {
        this.uuid = uuid;
    }
    ...
    public boolean equals(Object o) {
        ...
        Map this$uuid = this.getUuid();
        Map other$uuid = other.getUuid();
    ...
    public String toString() {
        return "EncryptResponseVo(respCode=" + this.getRespCode() + ", respMsg=" + this.getRespMsg() + ", logRefId=" + this.getLogRefId() + ", uuid=" + String.valueOf(this.getUuid()) + ")";
    }
}
