...
public class FileUploadLogEntity {
    ...
    @ManyToOne
    @JoinColumn(name="UPL_FOR_CODE", referencedColumnName="FOR_CODE")
    private FileFormatsEntity fileFormats;
    @Column(name="UPL_REMARKS")
    private String remarks;
    @ManyToOne
    @JoinColumn(name="UPL_PRJ_SER_NUMBER", referencedColumnName="PRJ_SER_NUMBER")
    private ProcessingJobsEntity processingJobs;
    ...
    public ProcessingJobsEntity getProcessingJobs() {
    ...
    public void setProcessingJobs(ProcessingJobsEntity processingJobs) {
    ...
    public boolean equals(Object o) {
        ...
        ProcessingJobsEntity this$processingJobs = this.getProcessingJobs();
        ProcessingJobsEntity other$processingJobs = other.getProcessingJobs();
        return !(this$processingJobs == null ? other$processingJobs != null : !this$processingJobs.equals(other$processingJobs));
    }
    ...
    public int hashCode() {
        ...
        ProcessingJobsEntity $processingJobs = this.getProcessingJobs();
        result = result * 59 + ($processingJobs == null ? 43 : $processingJobs.hashCode());
        return result;
    }

    public String toString() {
        return "FileUploadLogEntity(serialNumber=" + this.getSerialNumber() + ", lastUpdated=" + String.valueOf(this.getLastUpdated()) + ", updatedUser=" + this.getUpdatedUser() + ", institutionCode=" + this.getInstitutionCode() + ", interfaceCode=" + this.getInterfaceCode() + ", fileName=" + this.getFileName() + ", uploadDate=" + String.valueOf(this.getUploadDate()) + ", uploadStatus=" + this.getUploadStatus() + ", processingDate=" + String.valueOf(this.getProcessingDate()) + ", businessDate=" + String.valueOf(this.getBusinessDate()) + ", fileId=" + this.getFileId() + ", totalAcceptedTxnCount=" + this.getTotalAcceptedTxnCount() + ", totalTxnCount=" + this.getTotalTxnCount() + ", fileFormats=" + String.valueOf(this.getFileFormats()) + ", remarks=" + this.getRemarks() + ", processingJobs=" + String.valueOf(this.getProcessingJobs()) + ")";
    }
}
